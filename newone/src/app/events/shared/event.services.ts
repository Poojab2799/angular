...
export class Eventservice
{
  ...
  constructor(private http:HttpClient)
  {
    ...
    searchSessions(searchTerm: string):Observable<ISession[]> {
      return this.http.get<ISession[]>('http://localhost:4200/api/sessions/search?search=' + searchTerm)
    ...
    {
       return this.http.get<IEvent[]>('http://localhost:4200/api/events')
    ...
    {
      return this.http.get<IEvent>('http://localhost:4200/api/events/' + id)
